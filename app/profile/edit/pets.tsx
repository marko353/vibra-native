...
export default function PetsScreen() {
  ...
  useEffect(() => {
    if (params.currentPets) {
      setSelectedOption(params.currentPets as string);
    }
  }, [params.currentPets]);
  ...
  const handleSave = useCallback(() => {
    if (selectedOption) {
      router.navigate({
        ...
        params: { updatedPets: selectedOption },
      });
    } else {
      Alert.alert("Greška", "Molimo odaberite opciju za ljubimce.");
    }
