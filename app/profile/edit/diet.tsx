...
export default function DietScreen() {
  ...
  useEffect(() => {
    if (params.currentDiet) {
      setSelectedOption(params.currentDiet as string);
    }
  }, [params.currentDiet]);
  ...
  const handleSave = useCallback(() => {
    if (selectedOption) {
      router.navigate({
        ...
        params: { updatedDiet: selectedOption },
      });
    } else {
      Alert.alert("Greška", "Molimo odaberite opciju za ishranu.");
    }
  ...
  return (
    <SafeAreaView style={styles.safeArea}>
      ...
      <View style={styles.header}>
        ...
        <Text style={styles.headerTitle}>Ishrana</Text>
