// app/profile/edit/familyPlans.tsx
...
const familyPlansOptions = [
  ...
  "Ne želim decu",
  "Nisam siguran/na",
  "Imam decu i želim više",
  "Imam decu i ne želim više",
];
...
export default function FamilyPlansScreen() {
  ...
  useEffect(() => {
    if (params.currentFamilyPlans) {
      setSelectedOption(params.currentFamilyPlans as string);
    }
  ...
  const handleSave = useCallback(() => {
    if (selectedOption) {
      router.navigate({
        ...
        params: { updatedFamilyPlans: selectedOption },
      });
    } else {
      Alert.alert("Greška", "Molimo odaberite opciju za porodične planove.");
    }
  }, [selectedOption, router]); // Dodat 'router' u zavisnosti
