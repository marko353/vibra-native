// app/profile/edit/sexualOrientation.tsx
...
export default function SexualOrientationScreen() {
  ...
  useEffect(() => {
    if (params.currentSexualOrientation) {
      setSelectedOption(params.currentSexualOrientation as string);
    }
  }, [params.currentSexualOrientation]);

  const handleSave = useCallback(() => {
    if (selectedOption) {
      router.navigate({
        pathname: '/profile/edit-profile', // Ispravna putanja nazad
        params: { updatedSexualOrientation: selectedOption },
      });
    } else {
      Alert.alert("Greška", "Molimo odaberite seksualnu orijentaciju.");
    }
