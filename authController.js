...
exports.resetPasswordRedirect = (req, res) => {
  ...
  const intentLink = `intent://reset-password?userId=${encodeURIComponent(userId)}&token=${encodeURIComponent(token)}#Intent;scheme=vibra-date;package=com.marko353.vibradate;end`;
