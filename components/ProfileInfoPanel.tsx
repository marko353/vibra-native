  ...
  <View>
    ...
    <View style={detailsStyles.contentContainer}>
      <View style={detailsStyles.headerSection}>
        <View
          style={[
            detailsStyles.skeleton,
            { width: "60%", height: 30, borderRadius: 8, marginBottom: 15 },
          ]}
        />
        <View
          style={[
            detailsStyles.skeleton,
            { width: "90%", height: 18, borderRadius: 4 },
          ]}
        />
      </View>
      <View
...
const DetailCard: React.FC<DetailCardProps> = ({ iconName, title, value }) => {
  ...
  if (title === "Pol") {
    displayValue = getGenderLabel(value as string);
  }
  return (
...
const ProfileInfoPanel: React.FC<ProfileInfoPanelProps> = ({
  ...
  useEffect(() => {
    ...
    if (isVisible && !isLoading) {
      const animations = sectionAnims.map((anim) =>
      ...
      const opacities = sectionAnims.map((anim) =>
  ...
  const images =
    (profileData?.profilePictures?.filter(Boolean) as string[]) || [];
  ...
  const imageTranslateY = scrollY.interpolate({
    ...
    outputRange: [HEADER_IMAGE_HEIGHT / 2, 0, -HEADER_IMAGE_HEIGHT / 2],
    extrapolate: "clamp",
  });
  ...
  const handleBlockUser = () => {
    Alert.alert(
      "Blokiranje",
      `Da li ste sigurni da želite da blokirate korisnika ${profileData?.fullName}?`
    );
  };
  ...
  const handleReportUser = () => {
    Alert.alert(
      "Prijava",
      `Da li ste sigurni da želite da prijavite korisnika ${profileData?.fullName}?`
    );
  };
  ...
  return (
    <Animated.View
      style={[
        detailsStyles.sliderOverlay,
        { transform: [{ translateY: slideAnim }] },
      ]}
    >
      <TouchableOpacity
        style={detailsStyles.touchableOverlay}
        onPress={onClose}
        activeOpacity={1}
      />
      <View style={detailsStyles.sliderContainer}>
        <Animated.View
          style={[
            detailsStyles.headerImageContainer,
            {
              transform: [
          ...
          {images.length > 0 ? (
            <Carousel
              ...
              renderItem={({ item }) => (
                <Image
                  source={{ uri: item }}
                  style={detailsStyles.headerImage}
                />
              )}
            />
          ) : (
        ...
        <Animated.ScrollView
          ...
          contentContainerStyle={detailsStyles.scrollViewContent}
        >
          {isLoading ? (
            <SkeletonLoader />
          ) : (
            <>
              ...
              <View style={detailsStyles.contentContainer}>
                ...
                >
                  <View style={detailsStyles.headerSection}>
                    <Text style={detailsStyles.fullNameText}>
                      {profileData?.fullName}
                      {age && `, ${age}`}
                    </Text>
                    {profileData?.bio && (
                      <Text style={detailsStyles.bioText}>
                        {profileData.bio}
                      </Text>
                    )}
                  </View>
                    ...
                    {hasAboutMeData && (
                      <Animated.View
                        style={{
                          ...
                          transform: [
                            { translateY: sectionAnims[1].translateY },
                          ],
                        }}
                      >
                    ...
                    {hasLifestyleData && (
                      <Animated.View
                        style={{
                          ...
                          transform: [
                            { translateY: sectionAnims[2].translateY },
                          ],
                        }}
                      >
                        <View style={detailsStyles.section}>
                    ...
                    {(profileData?.interests?.length ?? 0) > 0 && (
                      <Animated.View
                        style={{
                          ...
                          transform: [
                            { translateY: sectionAnims[3].translateY },
                          ],
                        }}
                      >
                        <View style={detailsStyles.section}>
                          ...
                          <View style={detailsStyles.tagsContainer}>
                            ...
                            {profileData?.interests?.map((interest, index) => (
                              <View key={index} style={detailsStyles.tag}>
                                <Text style={detailsStyles.tagText}>
                                  {interest}
                                </Text>
                              </View>
                            ))}
                    ...
                    {(profileData?.languages?.length ?? 0) > 0 && (
                      <Animated.View
                        style={{
                          ...
                          transform: [
                            { translateY: sectionAnims[4].translateY },
                          ],
                        }}
                      >
                        <View style={detailsStyles.section}>
                    ...
                    {hasBasicsData && (
                      <Animated.View
                        style={{
                          ...
                          transform: [
                            { translateY: sectionAnims[5].translateY },
                          ],
                        }}
                      >
                        <View style={detailsStyles.section}>
                  ...
                  >
                    <View style={detailsStyles.emptyStateContainer}>
                      <Ionicons
                        ...
                        style={detailsStyles.emptyStateIcon}
                      />
                      <Text style={detailsStyles.emptyStateTitle}>
                        {profileData?.fullName} je još uvek misterija!
                      </Text>
                      <Text style={detailsStyles.emptyStateSubtitle}>
                        Nema unetih detalja, ali to je prilika da započneš
                        razgovor i saznaš više.
                      </Text>
                      <Text style={detailsStyles.emptyStateCTA}>
                        Pošalji lajk da ga/je ohrabriš da popuni profil.
                      </Text>
                    </View>
                  </Animated.View>
                )}
                ...
                <View style={detailsStyles.actionsContainer}>
                  <TouchableOpacity
                    style={detailsStyles.actionLinkButton}
                    onPress={handleBlockUser}
                  >
                    <Text style={detailsStyles.actionLinkButtonText}>
                      Blokiraj korisnika {profileData?.fullName}
                    </Text>
                  </TouchableOpacity>
                  <TouchableOpacity
                    style={detailsStyles.actionLinkButton}
                  ...
                  >
                    <Text style={detailsStyles.actionLinkButtonText}>
                      Prijavi korisnika {profileData?.fullName}
                    </Text>
                  </TouchableOpacity>
                </View>
                ...
                <View style={detailsStyles.footerLogoContainer}>
                  <Image
                    ...
                    resizeMode="contain"
                  />
                  <Text style={detailsStyles.footerLogoText}>
                    Powered by App
                  </Text>
                </View>
              </View>
