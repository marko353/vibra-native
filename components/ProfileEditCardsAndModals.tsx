...
const ProfileEditCardsAndModals = ({
  ...
  const renderCard = (
    ...
    const cardContentStyle = isBioCard
      ? styles.bioCardContent
      : styles.cardContent;
  ...
  const renderLocationCard = () => {
    // LOGOVI ZA DEBUG
    console.log("[LOCATION CARD] profile.showLocation:", profile?.showLocation);
    console.log("[LOCATION CARD] locationCity prop:", locationCity);
    console.log("[LOCATION CARD] profile.location:", profile.location);

    const showLocation = profile?.showLocation ?? false;
    // Prikazujemo grad ako je showLocation true i postoji grad (iz prop-a ili profila)
    const cityToShow = locationCity || profile.location?.locationCity || "";
    console.log("[LOCATION CARD] cityToShow:", cityToShow);
    let locationValue = "Isključeno";
    if (showLocation) {
      locationValue = cityToShow ? cityToShow : "Lokacija uključena";
    }
    // log za novi fallback
    console.log("[LOCATION CARD] final locationValue:", locationValue);
    console.log("[LOCATION CARD] locationValue:", locationValue);
